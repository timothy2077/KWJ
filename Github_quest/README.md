...
LMS 7-1 스텝에서 내준 프로젝트 과제 내용입니다.  

## 마크 저커버그가 직접 만들어 본 AI 비서 ‘자비스’

* 출처 : [마크 저커버그가 직접 만들어 본 AI 비서 ‘자비스’](https://about.fb.com/ko/news/2016/12/%EB%A7%88%ED%81%AC-%EC%A0%80%EC%BB%A4%EB%B2%84%EA%B7%B8-ai-%EB%B9%84%EC%84%9C-%EC%9E%90%EB%B9%84%EC%8A%A4%EC%97%90-%EB%8C%80%ED%95%B4-%EC%9D%B4%EC%95%BC%EA%B8%B0%ED%95%98%EB%8B%A4/)  
...
* 출처 : [GPT-4 발표한 오픈AI '샘 알트만'](https://www.aitimes.kr/news/articleView.html?idxno=27595)  

> AI가 일자리를 대체할 것인가? 에 대해서 알트만은 이것이 가까운 장래에 일부 일자리를 대체할 가능성이 있으며 얼마나 빨리 일어날 수 있는지 걱정하고 있다고 밝혔다.
  
![샘 알트만](https://cdn.aitimes.kr/news/photo/202303/27595_41566_124.jpg)  
...
* 출처 : [세계 4대 AI 석학 앤드류 응 교수, "인공지능 업계에 영원한 봄 왔다"](https://www.donga.com/news/It/article/all/20230725/120394744/1)  
...
![앤드류 응 교](https://dimg.donga.com/wps/NEWS/IMAGE/2023/07/25/120394713.1.jpg)  
...
* 자주 사용하는 마크다운 문법을 원없이 사용해볼 수 있었음.
* 문장 끝마다 스페이스바 두 번 입력하는 것이 번거롭게 느껴지긴 하지만 마크다운 입장에서는 다른 포맷으로의 변환도 고려해야하기에 어쩔 수 없는 부분이라고 생각이 들었음.
  - 다만, 마크다운 해석기(렌더링 모듈) 차원에서 스페이스바가 두 번 입력되어 있지 않아도 개행문자를 자동으로 줄바꿈 처리할 수는 있을것 같지만 이렇게 처리하는 것 역시 표준은 아니어서 다른 곳으로 콘텐츠를 복사하거나 할 때 또 차이가 발생할 수 있기에 가급적 불편하더라도 표준을 지켜 작성하는 것이 필요할 것 같음.
* 확실히 다른 도구가 필요 없다는 것이 매우 큰 장점으로 느껴짐.
* 청소년 시기부터라도 마크다운 편집 능력 정도는 필수 역량으로 키워주는 것도 좋을 것으로 생각됨. 
